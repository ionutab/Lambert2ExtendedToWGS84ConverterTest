...
public class Lambert {
    ...
    public static Apfloat latitudeISOFromLat(double lat, double e) {
        return latitudeISOFromLat(new Apfloat(Double.valueOf(lat), PREC), new Apfloat(Double.valueOf(e), PREC));
    }
    ...
    public static LambertPoint lambertToGeographic(LambertPoint org, LambertZone zone, double lonMeridian, double e, double eps) {
        return lambertToGeographic(org, zone, new Apfloat(Double.valueOf(lonMeridian), PREC), new Apfloat(Double.valueOf(e), PREC), new Apfloat(Double.valueOf(eps), PREC));
    }
    ...
    private static LambertPoint geographicToCartesian(Apfloat lon, Apfloat lat, Apfloat he, double a, double e) {
        return geographicToCartesian(lon, lat, he, new Apfloat(Double.valueOf(a), PREC), new Apfloat(Double.valueOf(e), PREC));
    }
