...
public class EvolutionConvertToWGS84DegTest {
    ...
    public void testConvertToWGS84Deg(){
        ...
        assertEquals(pto1.getY(), pta1.getY().doubleValue(), DELTA_MINOR);
        assertEquals(pto1.getX(), pta1.getX().doubleValue(), DELTA_MINOR);
        assertEquals(pta1.getY().doubleValue(), ptar1.getY().doubleValue(), DELTA_MINOR);
        assertEquals(pta1.getX().doubleValue(), ptar1.getX().doubleValue(), DELTA_MINOR);
        ...
        assertEquals(pto2.getY(), pta2.getY().doubleValue(), DELTA_MINOR);
        assertEquals(pto2.getX(), pta2.getX().doubleValue(), DELTA_MINOR);
        assertEquals(pta2.getY().doubleValue(), ptar2.getY().doubleValue(), DELTA_MINOR);
        assertEquals(pta2.getX().doubleValue(), ptar2.getX().doubleValue(), DELTA_MINOR);
        ...
        assertEquals(pto3.getY(), pta3.getY().doubleValue(), DELTA_MINOR);
        assertEquals(pto3.getX(), pta3.getX().doubleValue(), DELTA_MINOR);
        assertEquals(pta3.getY().doubleValue(), ptar3.getY().doubleValue(), DELTA_MINOR);
        assertEquals(pta3.getX().doubleValue(), ptar3.getX().doubleValue(), DELTA_MINOR);
        ...
        assertEquals(pto4.getY(), pta4.getY().doubleValue(), DELTA_MINOR);
        assertEquals(pto4.getX(), pta4.getX().doubleValue(), DELTA_MINOR);
        assertEquals(pta4.getY().doubleValue(), ptar4.getY().doubleValue(), DELTA_MINOR);
        assertEquals(pta4.getX().doubleValue(), ptar4.getX().doubleValue(), DELTA_MINOR);
    }
